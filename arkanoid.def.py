...
fondo_ganar_img = pygame.image.load("imagen/44df237ddf0fa26582897dabb7ca5335.jpg")  # Cambia tu imagen
...
fondo_perder_img = pygame.image.load("imagen/c68dc25a5fefae8f70c5a278664e4850.jpg")  # Cambia tu imagen
...
while jugar:
    ...
    # --- Pantalla GANASTE ---
        ...
        mensaje = font_grande.render("GANASTE", True, GREEN)
